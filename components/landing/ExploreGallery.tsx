    ...
    <div className="max-w-6xl mx-auto mt-8">
      <Marquee gradient={false} speed={40} pauseOnHover={true} direction="left">
        {images.map((img, idx) => (
          <div
            key={idx}
            className="mx-2 rounded-xl overflow-hidden shadow-lg bg-background hover:shadow-xl transition-shadow duration-300"
          >
...
export function ExploreGallery() {
  ...
  return (
    <section
      id="gallery"
      className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-b from-background to-background/95"
    >
      <div className="">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-sm mb-4 font-medium">Examples ads generated</h3>
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-foreground leading-tight mb-2 font-bold">
            All these ads were one-shot by Krillion AI. Try it to believe!
          </h1>
        </div>
        <Tabs
                ...
                <TabsTrigger
                  ...
                  className={cn(
                    ...
                    selectedCategory === cat.category
                      ...
                      : "border-border text-muted-foreground hover:border-brand-600/50"
                  )}
                >
                  {cat.category}
                </TabsTrigger>
