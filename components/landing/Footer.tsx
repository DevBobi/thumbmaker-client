    ...
    <footer className="border-t">
      <div className="max-w-7xl mx-auto py-12 md:py-16 px-6">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          {/* Ad Categories */}
          <div className="space-y-3">
            <h3 className="font-semibold text-base">Ad Categories</h3>
            <ul className="space-y-2 text-sm">
              <li className="hover:text-brand-600 transition-colors">
                eCommerce Ads
              </li>
          ...
          {/* Creation Tools */}
          <div className="space-y-3">
            <h3 className="font-semibold text-base">Creation Tools</h3>
            <ul className="space-y-2 text-sm">
              <li className="hover:text-brand-600 transition-colors">
                Product Profiling
              </li>
        ...
        <div className="mt-12 border-t pt-8 text-center">
          <p className="text-xs text-muted-foreground">
            © 2025 <span className="font-semibold">Krillion AI</span>. All
            rights reserved.
          </p>
        </div>
      </div>
