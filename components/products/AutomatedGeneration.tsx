  ...
  const handleAutoGenerate = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      if (activeSource === "text") {
        ...
        const response = await authFetch("/api/products/create-with-text", {
          method: "POST",
          body: JSON.stringify({
      ...
      if (activeSource === "url") {
        ...
        const response = await authFetch("/api/products/create-with-website", {
          method: "POST",
          body: JSON.stringify({
            name: values.productName,
      ...
      if (activeSource === "document") {
        ...
        const response = await authFetch("/api/products/create-with-document", {
          method: "POST",
          body: JSON.stringify({
            name: values.productName,
