      ...
      <div className="p-3 bg-background">
        <div>
          ...
          <div className="flex items-center justify-between gap-2 mt-1">
            <div>
              <p className="text-[9px] text-muted-foreground truncate">Niche</p>
            ...
            <div>
              ...
              <div className="text-[10px] py-0.5 ">{template.category}</div>
            </div>
            <div>
              <p className="text-[9px] text-muted-foreground truncate">
                Sub Niche
              </p>
              <div className="text-[10px] py-0.5 ">{template.subNiche}</div>
            </div>
          </div>
        </div>
      </div>
